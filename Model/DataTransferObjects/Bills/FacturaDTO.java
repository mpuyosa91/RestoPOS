 ...
 * @author MoisesE
 */
public final class FacturaDTO implements IFacturable{
    
    public FacturaDTO (int ID,int turno,String identifier,Calendar date, double duration){
        this.ID = ID;
    ...
    public FacturaDTO (IClientable cliente, int idFactura){
        ID = idFactura;
    ...
    public FacturaDTO (FacturaDTO dto){
        ID = dto.getID();
        ...
        if (dto.getDown()!=null)this.down   = new FacturaDTO(dto.getDown());
        else                    this.down   = null;
    }
    
    @Override public void setDown(FacturaDTO dto)           { this.down = dto;                  }
    ...
    @Override public FacturaDTO getDown()                   { return down;                      }
