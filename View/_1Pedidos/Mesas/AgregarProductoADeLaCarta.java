...
import View.Templates.MiniWindowDialog;
...
//------------------------------------------------------------------------------
    ...
    private class buttonEliminarActionListener implements ActionListener{
        public buttonEliminarActionListener(DeLaCartaDTO dto, DeInventario composition){
            this.dto = dto;
    ...
    private void setDeLaCartaListLabelAndButtons(){
        ...
        if (!dto.getComposition().isEmpty()){
            for (DeInventario compositionDTO: dto.getComposition()){
