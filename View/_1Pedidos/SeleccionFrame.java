...
public class SeleccionFrame extends MiniWindowDialog{
    ...
    public SeleccionFrame(MainFrame contextFrame, JFrame frame, boolean modal, ISellable clase) {
        ...
        this.clase = clase;
        externalDto = new DeInventario(0,DeInventario.DeInventarioType.Producto);
        createObjects();
        createPanels();
    }
...
//------------------------------------------------------------------------------    
    public DeInventario externalDto;
    ...
    private class SeleccionadorISellable implements ActionListener{
        ...
        @Override public void actionPerformed(ActionEvent e) {
            if (!producto.isFinal())
                ...
                externalDto = IDataBase.searchByIdInDB(producto.getID());
