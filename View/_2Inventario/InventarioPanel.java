...
import View._2Inventario.Ingresar.IngresarFrame;
import View.MainFrame;
import View.Templates.IFrame;
import View._2Inventario.Listar.ListFrame;
...
public class InventarioPanel extends javax.swing.JPanel{
    ...
    private void initComponents(){
        ...
        btnList.get(i).addActionListener((ActionEvent e) -> {
            IInventariable.toThermalPrinter(IDataBase.SUBPRODUCTODTO);
        }); i++;
        btnList.get(i).addActionListener((ActionEvent e) -> {
            ISellable.toThermalPrinter(IDataBase.PRODUCTODTO);
        }); i++;
        btnList.get(i).addActionListener((ActionEvent e) -> {
            ISellable.toThermalPrinter(IDataBase.DELACARTADTO);
        }); i++;
    }
