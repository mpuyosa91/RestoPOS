 ...
 */
package View._2Inventario.Listar;
...
public class ListFrame extends javax.swing.JFrame implements IFrame{
    ...
    public void startframe(){
        ...
        switch(identifier){
            case Ingrediente:
                consoleTextArea.setText(IDataBase.INGREDIENTEDTO.treeToString());
                break;
            case SubProducto:
                consoleTextArea.setText(IDataBase.SUBPRODUCTODTO.treeToString());
                break;
            case Producto:
                consoleTextArea.setText(IDataBase.PRODUCTODTO.treeToString());
                break;
            case DeLaCarta:
                consoleTextArea.setText(IDataBase.DELACARTADTO.treeToString());
                break;
        }
    ...
    private void createContentPanel(){
        ...
        switch(identifier){
            case Ingrediente:
                aux = IDataBase.INGREDIENTEDTO.treeToString();
                break;
            case SubProducto:
                aux = IDataBase.SUBPRODUCTODTO.treeToString();
                break;
            case Producto:
                aux = IDataBase.PRODUCTODTO.treeToString();
                break;
            case DeLaCarta:
                aux = IDataBase.DELACARTADTO.treeToString();
                break;
        }
