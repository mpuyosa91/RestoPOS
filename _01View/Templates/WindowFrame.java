 ...
 * @author MoisesE
 */
public class WindowFrame extends javax.swing.JFrame implements IFrame{
    ...
    public WindowFrame(MainFrame contextFrame){
        ...
        x =                               0;    y = navigationPanel_ySize;
        w = (int)(xSize * xPanel1SizeRatio);    h = ySize - navigationPanel_ySize;
        this.LeftPanel_Rectangle    = new Rectangle(x, y, w, h);
        
        x = (int)(xSize * xPanel1SizeRatio);    y = navigationPanel_ySize;
        w = (int)(xSize * xPanel2SizeRatio);    h = ySize - navigationPanel_ySize;
    ...
    private void configureContainerPanels(){
        ...
        createConsolePanel();       containerPanel.add(consoleScrollPane);       
    }        
}