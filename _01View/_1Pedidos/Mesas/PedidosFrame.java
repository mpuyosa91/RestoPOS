...
import _03Model.Customers.Customer.ClienteTypes;
...
import _01View._1Pedidos.SeleccionFrame;
...
//------------------------------------------------------------------------------
    ...
    private void createClientePanel(){
        ...
        seleccionProductoButton.addActionListener((ActionEvent e) -> {
            SeleccionFrame seleccionador = new SeleccionFrame(contextFrame,thisFrame,true,generalController.PRODUCTODTO);
            Inventory externalDto = new Inventory(0,Inventory.DeInventarioType.Producto);
        ...
        seleccionDeLaCartaButton.addActionListener((ActionEvent e) -> {
            SeleccionFrame seleccionador = new SeleccionFrame(contextFrame,thisFrame,true,generalController.DELACARTADTO);
            Inventory externalDto = new Inventory(0,Inventory.DeInventarioType.DeLaCarta);
            seleccionador.startDialog();
            if (!"NoEstablecido".equals(seleccionador.externalDto.getNombre()))
                ingresarProducto(seleccionador.externalDto);
        });
    ...
    private void ingresarProducto(Inventory dto){
