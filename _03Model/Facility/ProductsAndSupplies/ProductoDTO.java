 ...
 * @author MoisesE
 */
public class ProductoDTO extends Inventory implements ISellable, IRetainerIngrediente, IRetainerSubProducto, IRetainerProducto{
...
//******************************************************************************  
    ...
    @Override public ArrayList<Inventory> getComposition(){
        ArrayList<Inventory> r = new ArrayList<>();
